...
function startGame() {
    ...
    // SET PLAYER PROFILE PIC
    let ran = Math.floor(Math.random() * 3) + 1;
    console.log(ran);
    let playerPfp = document.createElement("img"); 
    playerPfp.style.height = "140px";
    playerPfp.style.weight = "140px";
    playerPfp.style.borderRadius= "50%";

    playerPfp.src = "img/player-pfps/player-" + ran + ".jfif";
    document.getElementById("player-pfps").append(playerPfp);
